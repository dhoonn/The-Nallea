...
<div class="top">
		<div>
			<span style="color: #8C8C8C; margin-left: 133px;">11월 30일 월요일 : </span> 
			<span style="color: #FFFFFF;">9:00 AM - 5:30 PM</span> <span>
				<div style="float: right;">
				
				
				<c:choose>
				<c:when test="${sessionScope.loginId ne null}">
				<h4 style="font-size: 15px; margin-left: 635px; margin-top: -3px;">${sessionScope.loginId}님환영합니다.</h4>
				</c:when>
	...
	<div class="topnav">
		...
		<a href="<c:url value='/placelist'/>">즐길거리</a>
		...
		<a href="">항공권</a>
			...
			<a href="<c:url value='/areasearch'/>"style="margin-top: 0px;"><i class="fas fa-search" id="h_area"></i></a>
			<!-- 검색 -->
...
<body>
	<div class="body1">
		...
		<button onclick="calendar()" style="font-size: 15px;">
