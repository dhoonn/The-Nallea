...
public class NaverLoginApi {
	...
	private final static String CLIENT_ID = "h1AT4a7i38C4zkRFbW61";
	//h1AT4a7i38C4zkRFbW61
	private final static String CLIENT_SECRET = "OMWzTxuOFE";
	//OMWzTxuOFE

	private final static String REDIRECT_URI = "http://localhost:8090/thenale/naverloginok";
