...
<body>
    ...
    <p></p>    
	비밀번호<br>
	<input type="text" name="m_password" id="m_password" onkeyup="pwdCheck1()"><br> 
	<span id="pwdch"></span><br>
	<p></p>
	비밀번호 확인<br>
	<input type="text" name="m_passwordch" id="m_passwordch" onkeyup="pwdEqFn1()"><br> <span id="pwdEq"></span><br>
	<p></p>
	이름<br>
	<input type="text" name="m_name" id="m_name"><br>
	이메일<br>
	<input type="text" name="m_email" id="m_email"><button type="button">이메일 인증하기</button><br>
	이메일 인증<br>
	<input type="text" name="#" id="#"><br>
	<p></p>
	전화번호<br>
	<input type="text" name="m_phone" id="m_phone" onkeyup="phonech()"><br>
	<span id="pch"></span><br>
	<p></p> 
	프로필<br>
